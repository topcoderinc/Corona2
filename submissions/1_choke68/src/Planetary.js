/**
 * class: Planetary
 * Provides planetary component
 */
import React from 'react';
import planetaryjs from './lib/planetaryjs';
...
class Planetary extends React.Component {
   ...
   componentDidMount() {
      ...
      var canvas = document.getElementById('planetaryCanvas');
   ...
   render() {
      return (
        <div>
          <div id='controls'>
            <div>
              <input id='slider' type='range' min='0' max='100' step='0.1' value='0' readOnly>
              </input>
            </div>
            <div>
              <span id='date'></span>&nbsp;
          ...
          <canvas id='planetaryCanvas'></canvas>
        </div>
      );
   }
}
